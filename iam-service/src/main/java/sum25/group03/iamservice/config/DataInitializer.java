...
public class DataInitializer {
    ...
    private final CognitoService cognitoService; // ✅ thêm Cognito service
    ...
    public void init() {
        ...
        if (!userRepository.existsByEmail("admin@system.com")) {
            // Gọi Cognito để tạo user trước
            try {
                cognitoService.createAdminUser("admin@system.com", "TempPass123!");
                System.out.println("✅ Admin user created in Cognito");
            } catch (Exception e) {
